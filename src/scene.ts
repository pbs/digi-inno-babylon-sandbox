...
// In order to load .glTF files, we bring the glTF loader into scope
...
// import the duck model's location
...
export const createScene = async (
  ...
  // import the duck mesh to the scene
  await SceneLoader.ImportMeshAsync("", duckUrl, undefined, scene);

  // Create an XR experience with this scene and the ground mesh created earlier
